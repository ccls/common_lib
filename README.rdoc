...
This will probably not endure any further development, but I'm leaving it just in case.



I've included most of ruby_extension and some of rails_extension.  Still working on it.
...
This gem would then be used by ALL of the ccls apps and the engine.  The following would be kept separate and used only for testing.
