...
<label class="label" for="form_model_string_field">String field</label><select id="form_model_string_field" name="form_model[string_field]"><option value="">-select-</option>
<option value="M">male</option>
<option value="F">female</option>
...
<label class="label" for="form_model_datetime_field">Datetime field</label><input class="datetimepicker" id="form_model_datetime_field" name="form_model[datetime_field]" type="text" />
...
<label class="label" for="form_model_date_field">Date field</label><input class="datepicker" id="form_model_date_field" name="form_model[date_field]" type="text" />
	...
	test "wrapped_date_text_field with block" do
		...
		expected = %{<form accept-charset="UTF-8" action="/" class="new_form_model" id="new_form_model" method="post"><div style="display:none"><input name="utf8" type="hidden" value="&#x2713;" /></div><div class='date_field date_text_field field_wrapper'>
<label class="label" for="form_model_date_field">Date field</label><input class="datepicker" id="form_model_date_field" name="form_model[date_field]" type="text" />testing
</div><!-- class='date_field date_text_field' --></form>}
		assert_equal expected, output_buffer
	end
...
<label class="label" for="form_model_string_field">String field</label><select id="form_model_string_field" name="form_model[string_field]"><option value="">Meridiem</option>
<option value="AM">AM</option>
...
<label class="label" for="form_model_string_field">String field</label><input id="form_model_string_field" name="form_model[string_field]" type="text" /><span>I'm after</span>
	...
	test "wrapped_text_field with block with wrapped_text_field" do
		...
		expected = %{<form accept-charset="UTF-8" action="/" class="new_form_model" id="new_form_model" method="post"><div style="display:none"><input name="utf8" type="hidden" value="&#x2713;" /></div><div class='string_field text_field field_wrapper'>
<label class="label" for="form_model_string_field">String field</label><input id="form_model_string_field" name="form_model[string_field]" type="text" /><div class='integer_field text_field field_wrapper'>
<label class="label" for="form_model_integer_field">Integer field</label><input id="form_model_integer_field" name="form_model[integer_field]" type="text" />
...
<input name="form_model[string_field]" type="hidden" value="0" /><input id="form_model_string_field" name="form_model[string_field]" type="checkbox" value="1" /><label class="label" for="form_model_string_field">String field</label><div class='integer_field text_field field_wrapper'>
<label class="label" for="form_model_integer_field">Integer field</label><input id="form_model_integer_field" name="form_model[integer_field]" type="text" />
	...
	test "wrapped_check_box with post_text" do
		output_buffer = form_for(FormModel.new,:url => '/'){|f| 
			f.wrapped_check_box(:string_field, :post_text => "I'm after" ) }
		expected = %{<form accept-charset="UTF-8" action="/" class="new_form_model" id="new_form_model" method="post"><div style="display:none"><input name="utf8" type="hidden" value="&#x2713;" /></div><div class='string_field check_box field_wrapper'>
<input name="form_model[string_field]" type="hidden" value="0" /><input id="form_model_string_field" name="form_model[string_field]" type="checkbox" value="1" /><label class="label" for="form_model_string_field">String field</label><span>I'm after</span>
</div><!-- class='string_field check_box' --></form>}
		assert_equal expected, output_buffer
	end
...
<label class="label" for="form_model_integer_field">Integer field</label><select id="form_model_integer_field" name="form_model[integer_field]"><option value=""></option>
<option value="1">Yes</option>
<option value="2">No</option>
